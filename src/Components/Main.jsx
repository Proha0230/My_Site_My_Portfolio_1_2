...
function Main () {
    ...
    const [mySites, setMySites] = useState ([
        ...
        {id:7,
            name: "КАРТИНЫ.ART",
            img: "https://i.ibb.co/HrkGxSz/ART.jpg",
            description: "Третий полноценный законченный проект на нативном JS. В этом проекте очень много реализовано: Аккордеон, Слайдер, Модальные окна, Плавная анимация прокрутки страницы к элементам благодаря hash и requestAnimationFrame, Реализована возможность drag & drop загрузки изображений, Телефонная маска, Валидация полей для ввода имени/email и т.п. , Отправка на сервер php данных с модальных окон, включая отправку на сервер изображений которые добавил пользователь в загрузку в модальном окне и много всего другого.",
            ghlink: "https://github.com/Proha0230/Project_JS_PICTURES_ART",
            link: "https://proha0230.github.io/Project_JS_PICTURES_ART/"
        }
